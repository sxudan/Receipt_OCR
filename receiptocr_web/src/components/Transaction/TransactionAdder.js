    ...
    return (
        <div className="popup">
            ...
            <Row className="form-field">
                ...
                <Row className="form-field">
                    <p>Amount</p>
                    <input placeholder="Amount" value={data.amount} onChange={(e) => {
                        setData(
                            (prevData) => {
                                return {
                                    ...prevData, 
                ...
                <Row className="form-field">
                    <input type="date" value={getCurrentDate()} onChange={(e) => {
                       setData(
                        (prevData) => {
                            return {
                                ...prevData, 
                ...
                <Row>
                    {
                        !isLoading ? <Button onClick={() => {
                            setIsLoading(true)
                            handleUpload(props.profile.googleId, props.file, (progress) => {
                                ...
                                setData(
                                    ...
                                    updateDB(props.profile.googleId, {...data,image: url})
                                    setIsLoading(false)
                                    props.onClose()
